    ...
    <div class="container mx-auto p-6">
            ...
            <?php foreach ($myCourses as $course): ?>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="edit_course.php?id=<?php echo $course['id']; ?>" class="text-purple-600 hover:text-purple-800 transition duration-300">Edit</a>
                        <span class="text-gray-400">|</span>
                        <a href="?delete=<?php echo $course['id']; ?>" class="text-red-600 hover:text-red-800 transition duration-300" onclick="return confirm('Are you sure you want to delete this course?');">Delete</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
        ...
        <?php if (empty($myCourses)): ?>
            <div class="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <a href="add_course.php" class="mt-4 inline-block bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition duration-300">Add a Course</a>
            </div>
        <?php endif; ?>
    </div>
