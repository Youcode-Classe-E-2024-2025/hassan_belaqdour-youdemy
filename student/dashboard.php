...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto p-6">
        <nav class="flex space-x-6 mb-8">
            <a href="my_courses.php" class="text-purple-600 hover:text-purple-800 transition duration-300">My Courses</a>
            <a href="../public/index.php" class="text-purple-600 hover:text-purple-800 transition duration-300">View Catalog</a>
